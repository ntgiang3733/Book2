    	...
    	<div class="row">
            <div class="col-sm-8">
                            ...
                            <div class="checkbox">
                                <div class="check_box_one cashon_delivery">
                                    <label class="anim">
                                        <input type="checkbox" class="checkbox" checked style="float: left;">
                                        <span style="float: left;">
                                            Thanh toán hoặc đặt cọc giấy tờ khi nhận được hàng
                                        </span>
                ...
                <div class="resp-tabs-container hor_1" style="border-color: rgb(193, 193, 193);margin-top: 10px;">
                    <div class="resp-tab-content hor_1 resp-tab-content-active" aria-labelledby="hor_1_tab_item-0" style="display:block">
                        <div class="vertical_post check_box_agile">
                            <h5><i class="fas fa-hourglass-half"></i> Thời gian thuê đồ</h5>
                            <div class="checkbox">
                                <div class="check_box_one cashon_delivery">
                                    <label class="anim">
                                        <span style="float: right; margin-left: 500px;" >
                                             <select id="timehire" class="hiretime" onchange="tim(this)">
                                        ...
                                        <span>
                                             - Ngày thuê : <span id="t1"></span>
                                        </span><br/>
                                        <span>
                                             - Hạn trả   : <span id="t2"></span>
                                        </span>
                ...
                <div class="resp-tabs-container hor_1" style="border-color: rgb(193, 193, 193);margin-top: 10px;">
                    <div class="resp-tab-content hor_1 resp-tab-content-active" aria-labelledby="hor_1_tab_item-0" style="display:block">
                        <div class="vertical_post check_box_agile">
                            <h5><i class="fas fa-money-check-alt"></i> THỦ TỤC - ĐẶT CỌC THUÊ</h5>
                            <div class="checkbox">
                                <div class="check_box_one cashon_delivery">
                                    <label class="anim">
                                        <input type="checkbox" class="checkbox" checked style="float: left;">
                                        <span style="float: left;">
                                        Đặt lại một trong các giấy tờ tùy thân như:
                                            <p>Chứng minh thư (thẻ căn cước)</p>
                                            <p>Bằng lái xe</p>
                                            <p>Hộ chiếu còn hạn trên 6 tháng</p>
                                        </span>
                                    </label>
                                </div>
                                <div class="check_box_one cashon_delivery">
                                    <label class="anim">
                                        ...
                                        <span style="float: left;">
                                        Đặt cọc 50% giá trị sản phẩm
                                            
                                        </span>
                                        <span style="float: right; margin-left: 240px;">{{ number_format($price/2) }} VNĐ</span>
                                    </label>
                                </div>
                            </div>
                        </div>
