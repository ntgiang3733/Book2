                ...
                <div class="col-md-4 offer-footer my-md-0 my-4">
                    <div class="row">
                        ...
                        <div class="col-8 text-form-footer">
                            ...
                            <p>Miễn phí với đơn hàng trị giá trên 1.000.000đ</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 offer-footer">
                    <div class="row">
                        ...
                        <div class="col-8 text-form-footer">
                            ...
                            <p>Sản phẩm được bảo hành 1-24 tháng</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container py-md-5 py-sm-4 py-3">
            <div class="row footer-info w3-agileits-info">
                ...
                <div class="col-md-3 col-sm-6 footer-grids">
                    ...
                    <ul>
                        <li class="mb-3">
                            <a href="product.html">Trang chủ </a>
                        </li>
                        <li class="mb-3">
                            <a href="product.html">Sản phẩm</a>
                        </li>
                        <li class="mb-3">
                            <a href="product.html">Liên hệ</a>
                        </li>
                    </ul>
                </div>
                <!-- //footer categories -->
                ...
                <div class="col-md-3 col-sm-6 footer-grids mt-sm-0 mt-4">
                    <h3 class="text-white font-weight-bold mb-3">Chính sách công ty</h3>
                    <ul>
                        <li class="mb-3">
                            <a href="about.html">Chính sách thanh toán</a>
                        </li>
                        <li class="mb-3">
                            <a href="contact.html">Chính sách vận chuyển</a>
                        </li>
                        <li class="mb-3">
                            <a href="help.html">Chính sách đổi trả</a>
                        </li>
                        <li class="mb-3">
                            <a href="faqs.html">Chính sách bảo hành</a>
                        </li>
                    </ul>
                </div>
                <div class="col-md-3 col-sm-6 footer-grids mt-md-0 mt-4">
                    <h3 class="text-white font-weight-bold mb-3">Hotline:</h3>
                    <ul>
                        <li class="mb-3">
                            <i class="fas fa-phone"></i> +0123456789 </li>
                        <li class="mb-3">
