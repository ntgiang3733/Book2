...
export default class Edit extends Component {
    ...
    componentDidMount() {
        axios.get('http://localhost:8000/admin/category/edit/'+this.props.match.params.id)
        .then(response => {
    ...
    onSubmit(e) {
        ...
        axios.put('http://localhost:8000/admin/category/update/' + this.props.match.params.id, category)
        .then(res=>{
            ...
            <div>
                ...
                <form onSubmit={this.onSubmit}>
                    <div className="form-group">
                        ...
                        aria-describedby="emailHelp" placeholder={this.state.category_name} />
                    </div>
