...
class CartController extends Controller
{
    ...
    public function addCart($id, Request $request) {
        ...
        $cart = ['id' => $id , 'name' => $product->name , 'qty' => $qty , 'timehire' => $timehire , 'price' => $price , 'options' => ['img' => $product->image]];
        Cart::add($cart);
    ...
    public function checkout() {
        ...
        $t1 = Carbon::now('Asia/Ho_Chi_Minh')->toDateString();
        $t2 = Carbon::now('Asia/Ho_Chi_Minh')->addDay(7)->toDateString();
        return view('client.pages.checkout', compact('user','price','t1', 't2'));
    }
}
